...
(function() {
  ...
  if(!window.methodDraw) window.methodDraw = function($) {
    ...
    var curConfig = {
      canvas_expansion: 1,
      pageDimension: [794, 1121], // A4 at 96 DPI
      dimensions: [794, 1121 * 2],
      initFill: {color: '000', opacity: 1},
      initStroke: {width: 2.5, color: '000', opacity: 1},
      initOpacity: 1,
      imgPath: 'images/',
      extPath: 'extensions/',
...
//            || elem && elem.tagName == "path" && !multiselected) { // This was added in r1430, but not sure why
  ...
  //              var ref_data = Actions.getButtonData(opts.button);
      ...
      var str = '<div class="palette_item black" data-rgb="#000000"></div>';
...
//        var opacity = (picker == 'stroke' ? $('#stroke_opacity') : $('#fill_opacity'));
    ...
    var changeCanvasSize = function(ctl){
            ...
            submenu: [
              {
                ...
                click: insertPageAtEnd
              },
              {
                label: 'Delete Page At End',
                accelerator: 'CommandOrControl+Backspace',
                click: deletePageAtEnd
              },
              {
                type: 'separator'
              },
      ...
      $('#blur')         .dragInput({ min: 0,    max: 10,    step: .1,  callback: changeBlur,          cursor: true,  start: 0               });
        // Set default zoom
      $('#zoom').val(svgCanvas.getZoom() * 150);
